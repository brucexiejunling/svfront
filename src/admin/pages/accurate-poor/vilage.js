...
const page = {name: 'jzfp', text: '精准扶贫'}, tab = {name: 'vilage', text: '一村一品'}, PAGE_SIZE = 10 ;
export default class Vilage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            articles: [],
    ...
    render() {
        ...
        return (
            <div className='vilage'>
                <div className="title">说明：文章管理，以下是《一村一品》栏目下面的所有文章，您可以在这里管理这些文章</div>
