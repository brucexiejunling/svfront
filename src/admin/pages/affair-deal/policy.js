...
const page = {name: 'wybs', text: '我要办事'}, tab = {name: 'policy', text: '政策解读'}, PAGE_SIZE = 10 ;
        ...
        return (
            <div className='policy'>
                <div className="type-wrap">
                    <div className="title">说明：分类管理，您可以管理《政策解读》栏目下面的所有分类，编辑文章时候可以选择相应分类</div>
                    <div className="types-wrap"><Types data={this.props.types || []} onSubmit={this.submitTypes} /></div>
                </div>
                <div className="article-wrap">
                    <div className="title">说明：文章管理，以下是《政策解读》栏目下面的所有文章，您可以在这里管理这些文章</div>
