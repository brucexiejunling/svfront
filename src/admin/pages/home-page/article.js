...
const page = {name: 'home', text: '网站首页'}, tab = {name: '', text: ''}, PAGE_SIZE = 10 ;
export default class Animal extends Component {
    ...
    goCreateArticlePage(aid) {
        ...
        let url = `/admin/bjwz?pageName=${page.name}&pageText=${pageText}`
    ...
    deleteArticle(aid) {
        reqwest({
            url: hostname + '/api/article/remove',
            method: 'post',
            type: 'json',
            data: {
                id: aid
