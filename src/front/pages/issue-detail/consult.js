...
export default class Consult extends Component {
  ...
  handleSubmit() {
    ...
    showLoading();
    reqwest({
      url: `${hostname}/api/consult/reply`,
      method: 'get',
      type: 'jsonp',
    ...
    return (
      <div class="issue-detail">
        <div className="display-wrap">
          <div className="title"><span className="label">信访标题：</span><span>{data.title}</span></div>
          ...
          <div className="area"><span className="label">问题发生地：</span><span>{data.area}</span></div>
