...
!(function(t, e) {
  ...
  var e = (function() {
    ...
    function B(t) {
      var e, n;
      return c[t] ||
        ((e = f.createElement(t)), f.body.appendChild(e), (n = getComputedStyle(
          e,
          ''
        ).getPropertyValue('display')), e.parentNode.removeChild(e), 'none' ==
          n && (n = 'block'), (c[t] = n)), c[t];
    }
    function U(t) {
    ...
    return (N.matches = function(t, e) {
      ...
      return o && (i = A).appendChild(t), (r = ~N.qsa(i, e).indexOf(t)), o &&
        A.removeChild(t), r;
    }), (O = function(t) {
      ...
      var o, s, a;
      return d.test(t) && (o = r(f.createElement(RegExp.$1))), o ||
        (t.replace && (t = t.replace(m, '<$1></$2>')), n === e &&
          (n = p.test(t) && RegExp.$1), n in j || (n = '*'), (a = j[
          n
        ]), (a.innerHTML = '' + t), (o = r.each(
          u.call(a.childNodes),
          function() {
            a.removeChild(this);
          }
        ))), Z(i) &&
        ((s = r(o)), r.each(i, function(t, e) {
      ...
      return 'boolean' == typeof t &&
        ((e = t), (t = n.shift())), n.forEach(function(n) {
        J(t, n, e);
      }), t;
    }), (N.qsa = function(t, e) {
      var n,
      ...
      : function(t, e) {
          for (; e && (e = e.parentNode); )
            if (e === t) return !0;
          return !1;
        }), (r.type = $), (r.isFunction = F), (r.isWindow = k), (r.isArray = L), (r.isPlainObject = Z), (r.isEmptyObject = function(
      t
    ) {
      var e;
      for (e in t)
    ...
    }), (r.uuid = 0), (r.support = {}), (r.expr = {
    }), (r.noop = function() {}), (r.map = function(t, e) {
      var n, i, o, r = [];
      if (z(t))
      ...
      show: function() {
        return this.each(function() {
          'none' == this.style.display &&
            (this.style.display = ''), 'none' == getComputedStyle(this, '').getPropertyValue('display') && (this.style.display = B(this.nodeName));
        });
      },
      ...
      position: function() {
        if (this.length) {
          ...
          return (n.top -= parseFloat(r(t).css('margin-top')) ||
            0), (n.left -= parseFloat(r(t).css('margin-left')) ||
            0), (i.top += parseFloat(r(e[0]).css('border-top-width')) ||
      ...
      (r.fn[n] = function() {
        ...
        return s.length < 1
          ...
          : this.each(function(e, n) {
              (a = o
                ? n
                : n.parentNode), (n = 0 == i ? n.nextSibling : 1 == i ? n.firstChild : 2 == i ? n : null);
  ...
  return (t.Zepto = e), void 0 === t.$ && (t.$ = e), (function(e) {
    ...
    function x(t, e, n, r, i) {
      ...
      (e || '').split(/\s/).forEach(function(e) {
        p(t, e, n, r).forEach(function(e) {
          delete a[
            o
          ][e.i], 'removeEventListener' in t && t.removeEventListener(v(e.e), e.proxy, g(e, i));
        });
      });
    }
    function T(t, n) {
      return (n || !t.isDefaultPrevented) &&
        ...
        }), t.timeStamp || (t.timeStamp = Date.now()), (n.defaultPrevented !== r
          ? n.defaultPrevented
          : 'returnValue' in n
              ? n.returnValue === !1
    ...
    (u.click = (u.mousedown = (u.mouseup = (u.mousemove = 'MouseEvents')))), (e.event = { add: y, remove: x }), (e.proxy = function(
      t,
      n
    ) {
    ...
    (e.fn.delegate = function(t, e, n) {
      ...
      return t && !s(t)
        ...
        : (s(n) || o(i) || i === !1 || ((i = n), (n = r)), i === !1 &&
            (i = E), a.each(function() {
            x(this, t, i, n);
          }));
    }), (e.fn.trigger = function(t, n) {
      return (t = s(t) || e.isPlainObject(t)
        ? e.Event(t)
        : T(t)), (t._args = n), this.each(function() {
      ...
      return this.each(function(o, a) {
        (r = S(s(t) ? e.Event(t) : t)), (r._args = n), (r.target = a), e.each(
          p(a, t.type || t),
          function(t, e) {
            return (i = e.proxy(r)), r.isImmediatePropagationStopped()
              ? !1
              : void 0;
          }
        );
    ...
    function y(t, e, n, r) {
      ...
      n.success.call(
        ...
        o,
        e
      ), r && r.resolveWith(i, [t, o, e]), d(n, i, 'ajaxSuccess', [e, n, t]), b(o, e, n);
    }
    function x(t, e, n, r, i) {
      var o = r.context;
      r.error.call(
        ...
        e,
        t
      ), i && i.rejectWith(o, [n, e, t]), d(r, o, 'ajaxError', [n, r, t || e]), b(e, n, r);
    }
    function b(t, e, n) {
      var r = n.context;
    ...
    function C(t, n, r, i) {
      return e.isFunction(n) &&
        ((i = r), (r = n), (n = void 0)), e.isFunction(r) || ((i = r), (r = void 0)), { url: t, data: n, success: r, dataType: i };
    }
    function O(t, n, r, i) {
      ...
      e.each(n, function(n, u) {
        (o = e.type(
          u
        )), i && (n = r ? i : i + '[' + (a || 'object' == o || 'array' == o ? n : '') + ']'), !i && s ? t.add(u.name, u.value) : 'array' == o || (!r && 'object' == o) ? O(t, u, r, n) : t.add(n, u);
      });
    }
    var i,
      o,
    ...
    (h.href = t.location.href), (e.active = 0), (e.ajaxJSONP = function(i, o) {
      ...
      return o && o.promise(h), e(u).on('load error', function(n, r) {
        clearTimeout(
          p
        ), e(u).off().remove(), 'error' != n.type && c ? y(c[0], h, i, o) : x(null, r || 'error', h, i, o), (t[a] = f), c && e.isFunction(f) && f(c[0]), (f = (c = void 0));
      }), v(h, i) === !1
        ? (l('abort'), h)
        : ((t[a] = function() {
            c = arguments;
            ...
            /\?(.+)=\?/,
            '?$1=' + a
          )), r.head.appendChild(u), i.timeout > 0 &&
            (p = setTimeout(
              function() {
                l('timeout');
              },
      ...
      m(s), s.crossDomain ||
        ((u = r.createElement(
          'a'
        )), (u.href = s.url), (u.href = u.href), (s.crossDomain = h.protocol +
          '//' +
          h.host !=
          u.protocol + '//' + u.host)), s.url ||
        (s.url = t.location.toString()), (f = s.url.indexOf('#')) > -1 &&
        (s.url = s.url.slice(0, f)), S(s);
      var c = s.dataType, p = /\?.+=\?/.test(s.url);
      if (
        (p && (c = 'jsonp'), (s.cache !== !1 &&
          ((n && n.cache === !0) || ('script' != c && 'jsonp' != c))) ||
          (s.url = T(s.url, '_=' + Date.now())), 'jsonp' == c)
      )
        return p ||
          (s.url = T(
            s.url,
      ...
      if (
        (a && a.promise(N), s.crossDomain ||
          b('X-Requested-With', 'XMLHttpRequest'), b(
          'Accept',
          d || '*/*'
        ), (d = s.mimeType || d) &&
          (d.indexOf(',') > -1 &&
            (d = d.split(',', 2)[0]), N.overrideMimeType &&
            N.overrideMimeType(d)), (s.contentType ||
        ...
        for (o in s.headers)
          b(o, s.headers[o]);
      if (
        ((N.setRequestHeader = b), (N.onreadystatechange = function() {
          if (4 == N.readyState) {
            ...
            if (
              ...
              if (
                ((c = c ||
                  w(
                    s.mimeType || N.getResponseHeader('content-type')
      ...
      return o.length > 1 &&
        ((u.url = o[0]), (a = o[1])), (u.success = function(t) {
        i.html(a ? e('<div>').html(t.replace(s, '')).find(a) : t), f &&
          f.apply(i, arguments);
      }), e.ajax(u), this;
    });
...
Location.prototype.getLocation = function(callback) {
  ...
  this.callback = Object.prototype.toString.call(callback) ==
    '[object Function]'
    ? callback
    : function(address) {
  ...
  if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(
      function(position) {
        ...
        self.getPositionInfo(longitude, latitude);
      },
      self.onError,
      options
    );
...
Location.prototype.getPositionInfo = function(longitude, latitude) {
  var self = this;
  $.getJSON(
    `//api.map.baidu.com/geocoder/v2/?ak=DOEKi19I91aFudLPLz0z5PoP&callback=?&location=${latitude},${longitude}&output=json&pois=0`,
    function(remoteData, status) {
      if(status == 'success' && remoteData.result && remoteData.result.addressComponent) {
        self.callback(remoteData.result.addressComponent);
      }
    }
  );
};
